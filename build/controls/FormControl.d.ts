...
interface IProps extends IContainer {
    ...
    value?: string | number | null;
    placeholder?: any;
    type?: 'text' | 'number' | 'numberfields' | 'numeric' | 'money' | 'static' | 'email' | 'password' | 'select' | 'customselect' | 'phonecode' | 'countrycode' | 'switch' | 'longtext' | 'datetime' | 'daterange' | 'uploader' | 'checkbox';
    name?: string;
    disabled?: boolean;
