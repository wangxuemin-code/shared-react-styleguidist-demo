declare module 'highcharts-react-official' {
   ...
   */
  type Constructor = (renderTo: HTMLElement, options: Highcharts.Options) => Highcharts.ChartObject;
  /**
   * Represents all of the strings that are keys of T that map to a Constructor function.
   */
  type ConstructorName<T> = { [K in keyof T]: T[K] extends Constructor ? K : never }[keyof T];
